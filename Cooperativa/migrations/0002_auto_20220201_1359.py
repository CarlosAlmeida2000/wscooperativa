...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='cooperativas',
            name='persona',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='Usuario.Personas'),
        ),
        migrations.AlterField(
            model_name='coopetaxis',
            name='taxista',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='taxista', to='Taxista.Taxistas'),
        ),
    ]
